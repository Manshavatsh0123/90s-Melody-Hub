...
const songs = [
    ...
    {
        id:3,
        songname:'Ek Ladki Ko Dekha<br><div class="subtitle">Kumar Sanu </div>',
    ...
    {
        id:6,
        songname:'Sochenge Tumhe Pyaar<br><div class="subtitle">Kumar Sanu </div>',
        poster:"img/sanu/6.jpg",
    },
    {
        id:7,
        songname:'Nazar Ke Saamne <br><div class="subtitle">Kumar Sanu</div>',
        poster:"img/sanu/7.jpg",
    },
    {
        id:8,
        songname:'Dil Ne Yeh Kaha Hai Dil Se<br><div class="subtitle">Kumar Sanu </div>',
    ...
    {
        id:10,
        songname:'Tumhe Apna Banane Ki Kasam<br><div class="subtitle">Kumar Sanu</div>',
    ...
    {
        id:13,
        songname:'Ab Tere Bin<br><div class="subtitle">Kumar Sanu</div>',
        poster:"img/sanu/13.jpg",
    },
    {
        id:14,
        songname:'Tu Mile Dil Khile<br><div class="subtitle">Kumar Sanu </div>',
        poster:"img/sanu/14.jpg",
    },
    {
        id:15,
        songname:'Bahut Pyar Karte Hain<br><div class="subtitle">Kumar Sanu </div>',
        poster:"img/sanu/15.jpg",
    },
    {
        id:16,
        songname:'Ae Kash Ke Hum<br><div class="subtitle">Kumar Sanu</div>',
        poster:"img/sanu/16.jpg",
    },
    {
        id:17,
        songname:'Tum Dil Ki Dhadkan Mein<br><div class="subtitle">Kumar Sanu</div>',
...
Array .from(document.getElementsByClassName('playlistPlay')).forEach((e) =>{
    e.addEventListener('click',(el) =>{
        index = el.target.id ;
        //console.log(index);
        music.src =`music/sanu/${index}.mp3`;
        poster_master_play.src = `img/sanu/${index}.jpg`;
        download_music.href = `music/sanu/${index}.mp3`;
        music.play();
        masterPlay.classList.add('fa-circle-pause');
        masterPlay.classList.remove('fa-circle-play');
